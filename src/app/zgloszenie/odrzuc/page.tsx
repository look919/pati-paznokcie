...
import { rejectRescheduleResponseAction } from "@/actions/rescheduleResponseAction";
    ...
    <PageWrapper className="md:p-0">
      <section className="py-12 px-4 md:px-6 bg-gradient-to-r w-full min-h-[calc(100vh-100px)] from-sky-400 to-blue-500 relative">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-center text-4xl font-light text-white mb-6 uppercase tracking-wide">
